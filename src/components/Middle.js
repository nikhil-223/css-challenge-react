				...
				<div className="notification">
					...
					<div className="notify_bottom">
						<div className="note">
							...
							<span className="noti">John Walker posted a photo on your wall.</span>
						</div>
						<div className="note">
							<span className="note_time">8:19 AM</span>
							<span className="noti">Alice Parker commented your last post.</span>
						</div>
						<div className="note">
			...
			<div className="info_container">
				<div className="info">
					<div className="info_item1">
						<div className="ppic"><img src="profile.jpg" alt="" /></div>
						<div className="pname">
